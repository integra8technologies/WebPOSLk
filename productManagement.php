...
<head>
    ...
    <title>Product Management | WebPOSLk</title>
...
<body class="h-full bg-slate-50 overflow-hidden" onload="loadProductsDetails();">
    <div class="h-full flex flex-col">
        ...
        <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex gap-3">
                <button class="px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-all">Export</button>
                <a class="px-4 py-2 bg-blue-800 text-white rounded-lg text-sm font-medium hover:bg-blue-900 transition-all flex items-center gap-2" href="addProduct.php">
        ...
        <div class="flex-1 flex overflow-hidden">
            <aside class="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-6 gap-6 flex-shrink-0">
                ...
                <a href="productManagement.php" class="w-12 h-12 rounded-2xl flex items-center justify-center bg-blue-50 text-blue-800 border border-blue-100 cursor-pointer shadow-sm">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-hidden flex flex-col p-6 gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border border-slate-200 flex flex-wrap gap-4 items-center shadow-sm">
                    <div class="flex-1 min-w-[300px] relative">
                        ...
                        <input type="text" id="manageSearch" onkeyup="loadProductsDetails();"
                ...
                <div class="flex-1 bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden flex flex-col">
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead class="bg-slate-50 sticky top-0 z-10">
                                <tr class="border-b border-slate-200">
                                    ...
                                    <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Cost Price</th>
                                    <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Selling Price</th>
                                    <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Stock</th>
                                    <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase">Status</th>
                                    <th class="px-6 py-4 text-xs font-bold text-slate-500 uppercase text-right">Actions</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-100" id="tb">
                                <!--load table data -->
                            </tbody>
                        </table>
                    </div>
                    ...
                    <!-- <div class="px-6 py-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
                        <span class="text-sm text-slate-500">Showing 1 to 10 of 42 products</span>
                        <div class="flex gap-1">
                            <button class="px-3 py-1 border border-slate-200 rounded text-sm bg-white text-slate-400 cursor-not-allowed">Prev</button>
                            <button class="px-3 py-1 border border-blue-200 rounded text-sm bg-blue-800 text-white font-medium">1</button>
                            <button class="px-3 py-1 border border-slate-200 rounded text-sm bg-white text-slate-600 hover:bg-slate-50 transition-all">2</button>
                            <button class="px-3 py-1 border border-slate-200 rounded text-sm bg-white text-slate-600 hover:bg-slate-50 transition-all">Next</button>
                        </div>
                    </div> -->
                </div>
            </main>
