...
<head>
    ...
    <title>View Categories | WebPOSLk</title>
...
<body class="h-full bg-slate-50 overflow-hidden" onload="loadCategoryCards();">
    <div class="h-full flex flex-col">
        ...
        <header class="bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between flex-shrink-0">
            ...
            <div class="flex gap-3">
                <a href="addCategory.php" class="px-4 py-2 bg-blue-800 text-white rounded-lg text-sm font-medium hover:bg-blue-900 transition-all flex items-center gap-2 shadow-sm">
        ...
        <div class="flex-1 flex overflow-hidden">
            <aside class="w-20 bg-white border-r border-slate-200 flex flex-col items-center py-6 gap-6 flex-shrink-0">
                ...
                <a href="viewCategories.php" class="w-12 h-12 rounded-2xl flex items-center justify-center bg-blue-50 text-blue-800 border border-blue-100 cursor-pointer shadow-sm">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <main class="flex-1 overflow-hidden flex flex-col p-6 gap-6">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" id="catItems">
